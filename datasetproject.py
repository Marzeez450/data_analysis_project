...
#Plot the number of complaint by gender
plt.figure(figsize=(8, 6))
sns.countplot(data=df, x='Gender', hue='Genre', palette='Set1')
plt.title('Complaint by Gender')
...
plt.title('Complaint by Nationality')
plt.xticks(rotation=90)
...
plt.title('Distribution of complaint by Age')
plt.savefig("custom_report_image/complaints_by_age.png")
...
plt.title('Number of Complaints Over the Academics Years')
plt.savefig("custom_report_image/complaints_over_the_academics_year.png")
...
plt.figure(figsize=(8, 6))
sns.countplot(data=df, x='Gender', hue='Genre', palette='Set1')
plt.title('Complaints by Gender Across Genre')
plt.savefig("custom_report_image/complaints_by_gender_across_genre.png")
...
<img src="custom_report_image/distribution_of_complaint_genres.png"
style="width: 800px; height:600px;" />

<img src="custom_report_image/complaints_by_age.png" style="width: 800px;height: 600px;" />
<img src="custom_report_image/complaints_by_gender_across_genre.png" style="width: 800px;height: 600px;" />
<img src="custom_report_image/complaints_by_nationality.png" style="width: 800px;height: 600px;" />
<img src="custom_report_image/complaints_over_the_academics_year.png" style="width: 800px;height: 600px;" />
